    ...
    <TermsContainer>
      <Row>
        <Col>
          ...
          <h6>Welcome to TredKJLifters!</h6>
          <p>
            These terms and conditions outline the rules and regulations for the use of TredKJLifters's Website, located
            at Website.com.
          </p>
          <p>
          ...
          <p>
            ...
            TredKJLifters's Privacy Policy.
          </p>
          <p>
            ...
            website. Some of our affiliate/advertising partners may also use cookies. License
          </p>
          <h6>License</h6>
          <p>
            Unless otherwise stated, TredKJLifters and/or its licensors own the intellectual property rights for all
          ...
          <p>
            ...
            certain areas of the website. TredKJLifters does not filter, edit, publish or review Comments prior to their
            presence on the website. Comments do not reflect the views and opinions of TredKJLifters,its agents and/or
            affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
            extent permitted by applicable laws, TredKJLifters shall not be liable for the Comments or for any liability,
          ...
          <ul>
            ...
            <li>
              limit any of our or your liabilities in any way that is not permitted under applicable law; or exclude any
              of our
            </li>
            <li>or your liabilities that may not be excluded under applicable law.</li>
          </ul>
